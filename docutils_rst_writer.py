...
"""
    ...
    :copyright: Copyright 2012-2022 by Freek Dijkstra and contributors.
    :license: BSD, see LICENSE.txt for details.

    This was adapted by Antmicro for standalone docutils use from https://github.com/sphinx-contrib/restbuilder/blob/master/sphinxcontrib/writers/rst.py
    The original is based on sphinx.writers.text.TextWriter, copyright 2007-2014 by the Sphinx team.
"""
